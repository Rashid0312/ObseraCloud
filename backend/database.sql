...
INSERT INTO tenants (tenant_id, company_name, email, password_hash, api_key, is_active) VALUES 
    ...
    ('Tourni1010', 'Tournament Platform', 'admin@tourni1010.com', '$2b$12$1fYm0Q.BuF9pjoHqriz.HuptL756VOSOW73SoHTh0uQhxMUWmwGda', 'tourni1010_api_key_prod', TRUE),
    ('rosseta', 'Rosseta Client', 'admin@rosseta.com', '$2b$12$YQeYhPOecgEVhVs3lRINruTI/dFTQquTlfKokGcgTNM5OOCsENmLW', 'rosseta_api_key_prod', TRUE)
ON CONFLICT (tenant_id) DO NOTHING;
